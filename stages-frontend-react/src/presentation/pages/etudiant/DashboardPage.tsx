  ...
  return (
    <>
      ...
      <div className="ml-64 min-h-screen bg-gray-50">
        ...
        <main className="p-6">
          <Card className="mb-6 bg-gradient-to-r from-primary-600 to-primary-500 text-white border-0">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-primary-100 text-sm">
                  {user?.filiere ?? "Etudiant"} — {user?.promotion ?? ""}
                </p>
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            ...
            <Card>
              ...
              <p className="text-3xl font-bold text-warning-600">
                {candidatures?.totalElements ?? 0}
              </p>
              <div className="flex gap-3 mt-2">
                <span className="text-xs text-success-600">
                  {acceptees} acceptee(s)
                </span>
                <span className="text-xs text-gray-400">
                  {list.filter((c) => c.statut === "EN_ATTENTE").length} en
                  attente
                </span>
              </div>
            </Card>
            ...
            <Card>
              ...
              <div className="h-2 bg-gray-100 rounded-full mt-3 overflow-hidden">
                <div
                  ...
                  style={{ width: taux + "%", backgroundColor: "#16a34a" }}
                />
              </div>
            </Card>
          </div>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {c.nomEntreprise} — {c.createdAt.slice(0, 10)}
                      </p>
                    </div>
                    <span
                      className={
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link
              to="/etudiant/offres"
              className="card flex items-center gap-4 hover:shadow-md transition-shadow border-l-4 border-primary-500"
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {offres?.totalElements ?? 0} offre(s) disponible(s)
                </p>
              </div>
            </Link>
            <Link
              to="/messagerie"
              className="card flex items-center gap-4 hover:shadow-md transition-shadow border-l-4 border-green-500"
            >
